...
export default function StartMenu({ setShowStart }) {
  return (
    <div className="border-collapse fixed bottom-14 left-1/2 -translate-x-1/2 flex flex-wrap justify-center content-start h-[380px] shadow-md shadow-black bg-gradient-to-b from-black to-gray-900 opacity-90">
